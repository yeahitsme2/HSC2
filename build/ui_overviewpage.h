...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        sizePolicy.setHeightForWidth(coinimage->sizePolicy().hasHeightForWidth());
        coinimage->setSizePolicy(sizePolicy);
        coinimage->setMinimumSize(QSize(250, 250));
        coinimage->setMaximumSize(QSize(250, 250));
        coinimage->setSizeIncrement(QSize(0, 0));
        coinimage->setBaseSize(QSize(0, 0));
        ...
        verticalLayout_2->addWidget(coinimage, 0, Qt::AlignHCenter);
