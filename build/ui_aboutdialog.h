...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_HSC_copyright = new QLabel(AboutDialog);
        label_HSC_copyright->setObjectName(QString::fromUtf8("label_HSC_copyright"));
        label_HSC_copyright->setWordWrap(true);
        label_HSC_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_HSC_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About HSC", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>HSC</b> version", 0, QApplication::UnicodeUTF8));
        label_HSC_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 HSC Developers", 0, QApplication::UnicodeUTF8));
